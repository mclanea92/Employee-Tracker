...
// used to create array of the departments i can pull
const deptArrFill = () => {
    const deptArr = [];
...
// where the newDepartment is added to the departments
const newDept = (obj) => {
